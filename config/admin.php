...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img src="/vendor/dcat-admin/images/logo.png" width="35"> &nbsp;Dcat Admin3',
   ...
   */
    ...
    */
    'auth' => [
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => Dcat\Admin3\Models\Administrator::class,
            ],
        ],
    ...
    */
    'grid' => [
        ...
        'grid_action_class' => Dcat\Admin3\Grid\Displayers\DropdownActions::class,

        // The global Grid batch action display class.
        'batch_action_class' => Dcat\Admin3\Grid\Tools\BatchActions::class,

        // The global Grid pagination display class.
        'paginator_class' => Dcat\Admin3\Grid\Tools\Paginator::class,

        'actions' => [
            'view' => Dcat\Admin3\Grid\Actions\Show::class,
            'edit' => Dcat\Admin3\Grid\Actions\Edit::class,
            'quick_edit' => Dcat\Admin3\Grid\Actions\QuickEdit::class,
            'delete' => Dcat\Admin3\Grid\Actions\Delete::class,
            'batch_delete' => Dcat\Admin3\Grid\Tools\BatchDelete::class,
        ],

        // The global Grid column selector setting.
        'column_selector' => [
            'store' => Dcat\Admin3\Grid\ColumnSelector\SessionStore::class,
            'store_params' => [
                'driver' => 'file',
            ],
        ],
    ...
    */
    'database' => [
        ...
        'users_model' => Dcat\Admin3\Models\Administrator::class,

        // Role table and model.
        'roles_table' => 'admin_roles',
        'roles_model' => Dcat\Admin3\Models\Role::class,

        // Permission table and model.
        'permissions_table' => 'admin_permissions',
        'permissions_model' => Dcat\Admin3\Models\Permission::class,

        // Menu table and model.
        'menu_table' => 'admin_menu',
        'menu_model' => Dcat\Admin3\Models\Menu::class,
    ...
    */
    ...
    |
    */
    'exception_handler' => Dcat\Admin3\Exception\Handler::class,
