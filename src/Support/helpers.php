...
if (! function_exists('admin_setting')) {
     ...
     * @param  mixed  $default
     * @return \Dcat\Admin3\Support\Setting|mixed
     */
...
if (! function_exists('admin_extension_setting')) {
    ...
    function admin_extension_setting($extension, $key = null, $default = null)
    {
        ...
        if ($extension instanceof Dcat\Admin3\Extend\ServiceProvider) {
...
if (! function_exists('admin_color')) {
     ...
     * @return string|\Dcat\Admin3\Color
     */
...
if (! function_exists('admin_javascript')) {
    ...
    {
        return Dcat\Admin3\Support\JavaScript::make($scripts);
    }
}
...
if (! function_exists('admin_javascript_json')) {
    ...
    {
        return Dcat\Admin3\Support\JavaScript::format($data);
    }
}
